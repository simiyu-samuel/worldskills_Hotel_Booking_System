        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav">
                    ...
                    <a href="adminstaffs.php" class="nav-item nav-link  active">STAFFS</a>
                </div>
...
<div class="container mt-5">
  <h2>LIST OF STAFFS</h2>  
      <a href="adminadduser.php" class="btn btn-primary mt-4">ADD STAFF</a>         
  <table border="2" class="table table-striped mt-4">
    ...
    <tbody>
      ...
      <tr>
                ...
                <td><?= $row['email'] ?></td>
                <td>
                    <a href="adminremoveuser.php?id=<?= $row['id'] ?>" class="btn btn-danger">REMOVE</a>
                </td>
                <?php
            }
        }
